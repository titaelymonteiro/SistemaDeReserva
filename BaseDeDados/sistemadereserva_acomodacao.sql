...
CREATE TABLE `acomodacao` (
  ...
  `quantidadeLeitos` int(11) DEFAULT NULL,
...
INSERT INTO `acomodacao` VALUES (1,'Single',1,50.00),(2,'Double',2,80.00),(3,'Suite',4,150.00),(4,'Single',1,55.00),(5,'Double',2,85.00),(6,'Suite',4,155.00);
